      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            <h1 className="text-xl font-semibold text-gray-900">Mantenimientos</h1>
            <p className="mt-2 text-sm text-gray-700">
              Aquí podras ver los mantenimientos para la empresa.
            </p>
          </div>
          <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
            ...
            >
              <Link href={"/gerencia-operativa/mantenimiento/AgregarMantenimiento"}>
            ...
            <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
              <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                <table className="min-w-full divide-y divide-gray-300">
                  ...
                  {mantenimientosMemo.map((mantenimiento) => (
                    <ListaMantenimientos
...
export default VerMantenimientos;
