...
interface Props {
  reporteDeVentasIndividual: ReporteVentasIndividual;
}

export const ReporteVentasIndividualPage: FC<Props> = ({
  reporteDeVentasIndividual,
}) => {
  const router = useRouter();

  const { actualizarReporteVentasIndividual, eliminarReporteVentasIndividual } =
  ...
  const [inputNombreVendedor, setInputNombreVendedor] = useState(reporteDeVentasIndividual.nombreDelVendedor);
  const [inputLugarDeLaVenta, setInputLugarDeLaVenta] = useState(reporteDeVentasIndividual.lugarDeVenta);
  ...
  const [inputSumaTotal, setInputSumaTotal] = useState(reporteDeVentasIndividual.totalDeLaVenta);

  const [inputListaDeProductos, setInputListaDeProductos] = useState<
    ListadoDeProductos[]
  >(reporteDeVentasIndividual.listadoDeProductos);

  const MySwal = withReactContent(Swal);

  const onInputValueChangedCodigoProducto = (
  ...
  const onInputValueChangedNombreVendedor = (
    event: ChangeEvent<HTMLInputElement>
  ) => {
    setInputNombreVendedor(event.target.value);
  };

  const onInputValueChangedLugarDeLaVenta = (
    event: ChangeEvent<HTMLSelectElement>
  ) => {
    setInputLugarDeLaVenta(event.target.value);
  };

  const onInputValueChangedTipoDeProducto = (
    event: ChangeEvent<HTMLSelectElement>
  ) => {
    setInputTipoDeProducto(event.target.value);
  };

  const onInputValueChangedSaborProducto = (
    event: ChangeEvent<HTMLSelectElement>
  ) => {
  ...
  const onInputValueChangedPrecioProducto = (
    event: ChangeEvent<HTMLInputElement>
  ) => {
    setInputPrecioProducto(parseInt(event.target.value));
  };

  const onInputValueChangedMonto = (
    event: ChangeEvent<HTMLInputElement>
  ) => {
    setInputMonto(parseInt(event.target.value));
  };

  const onInputValueChangedSumaTotal = (
    event: ChangeEvent<HTMLInputElement>
  ) => {
    setInputSumaTotal(parseInt(event.target.value));
  };

  // const onInputValueChangedListaDeProductos = (
  //   event: ChangeEvent<HTMLInputElement>
  // ) => {
  //   setInputListaDeProductos(event.target.value);
  // };
  ...
  const onSave = () => {
    if (
      ...
      inputNombreVendedor.trim().length === 0 &&
      inputLugarDeLaVenta.trim().length === 0 &&
      inputSumaTotal === 0 &&
    ...
    MySwal.fire({
      title: "¿Quieres actualizar la información a este reporte de ventas individual?",
      ...
      if (result.isConfirmed) {
        const actualizadoReporteVentasIndividual: ReporteVentasIndividual = {
          ...reporteDeVentasIndividual,
          fecha: inputFecha,
          nombreDelVendedor: inputNombreVendedor,
          lugarDeVenta: inputLugarDeLaVenta,
          totalDeLaVenta: inputSumaTotal,
          listadoDeProductos: inputListaDeProductos,
        };

        actualizarReporteVentasIndividual(actualizadoReporteVentasIndividual, true);
  ...
  const onDelete = () => {
    MySwal.fire({
      title: "¿Quieres eliminar a este reporte de ventas individual?",
      text: "Verifica los datos antes de la operación",
      icon: "warning",
      showCancelButton: true,
      ...
      if (result.isConfirmed) {
        eliminarReporteVentasIndividual(reporteDeVentasIndividual, true);
        router.push("/gerencia-de-ventas/reporteDeVentasIndividual/VerReporteDeVentasIndividual");
      }
    });
  };
            ...
            <div className="grid grid-cols-6 gap-6">
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  autoComplete="off"
                  className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary-yellow focus:border-primary-yellow sm:text-sm"
                  onChange={onInputValueChangedNombreVendedor}
                  // onBlur={() => setTouched(true)}
                />
              </div>
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <select
                  ...
                  onChange={onInputValueChangedLugarDeLaVenta}
                  // onBlur={() => setTouched(true)}
                >
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <select
                  ...
                  onChange={onInputValueChangedTipoDeProducto}
                  // onBlur={() => setTouched(true)}
                >
              ...
              <div className={"col-span-6 sm:col-span-3"}>
                ...
                <select
                  ...
                  onChange={onInputValueChangedSaborProducto}
                  // onBlur={() => setTouched(true)}
                >
                  <option hidden>Selecciona un producto...</option>
                  {validCakeFlavors
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  onChange={onInputValueChangedCodigoProducto}
                  // onBlur={() => setTouched(true)}
                  readOnly
                />
              </div>
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    onChange={onInputValueChangedPrecioProducto}
                    // onBlur={() => setTouched(true)}
                    readOnly
                  />
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    aria-describedby="price-currency"
                    value={inputMonto || 0}
                    onChange={onInputValueChangedMonto}
                    // onBlur={() => setTouched(true)}
                    readOnly
                  />
                  <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    onChange={onInputValueChangedSumaTotal}
                    // onBlur={() => setTouched(true)}
                    readOnly
                  />
                  <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
...
export default ReporteVentasIndividualPage;
