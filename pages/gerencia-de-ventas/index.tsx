...
const actions = [
  ...
  {
    title: "Reporte de ventas ambulantes generales",
  ...
  {
    title: "Ver Reporte de ventas ambulantes generales",
  ...
  {
    title: "Reporte de ventas ambulantes individuales",
  ...
  {
    title: "Ver Reporte de ventas ambulantes individuales",
...
export default function IndexGerenciaVentas() {
  return (
