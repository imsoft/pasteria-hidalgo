import { ProductosYaCompradosState } from ".";
...
type ProductosYaCompradosActionType =
  ...
  | {
      type: "[Producto Ya Comprado] Refrescar-Datos";
      payload: ProductoYaComprado[];
    }
  | {
...
export const productosYaCompradosReducer = (
  ...
  switch (action.type) {
    ...
    case "[Producto Ya Comprado] Actualizar-Producto Ya Comprado":
      return {
        ...state,
        productosYaComprados: state.productosYaComprados.map(
          (productoYaComprado) => {
